...
class AppColors {
  ...
  static const backgroundColor = const Color(0xFF5B604E);
  static const containerColor = const Color(0xFFD7CFD6);
  static const taskColor = const Color(0xFF542121);
  static const buttonColor = const Color(0xFF1E8748);
